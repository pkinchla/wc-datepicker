...
import { addDays, getDaysOfMonth, getFirstOfMonth, getFirstOfWeek, getISODateString, getLastOfMonth, getLastOfWeek, getMonth, getMonths, getNextDay, getNextMonth, getNextYear, getPreviousDay, getPreviousMonth, getPreviousYear, getWeekDays, getYear, isDateInRange, isSameDay, removeTimezoneOffset, subDays } from "../../utils/utils";
const defaultLabels = {
...
export class WCDatepicker {
    ...
    render() {
        ...
        return (h(Host, { key: 'a8a1bca738b0c4efed84c3737da70e8ce44232cb' }, h("div", { key: 'e84e11e1c15010ef42f955101a7ae809d023478b', "aria-disabled": String(this.disabled), "aria-label": this.labels.picker, class: {
                [this.getClassName()]: true,
                [`${this.getClassName()}--disabled`]: this.disabled
            }, role: "group" }, h("div", { key: 'f5ec57cb3143d6378bed8c220b13fe9f048ccd70', class: this.getClassName('header') }, h("span", { key: 'a06ff8e6902f9e5069037ba1ed288d84d6dd973e', "aria-atomic": "true", "aria-live": "polite", class: "visually-hidden" }, this.getTitle()), this.showYearStepper && (h("button", { key: 'c139bf5d1098dd175687e906dd1e0c8177db0878', "aria-label": this.labels.previousYearButton, class: this.getClassName('previous-year-button'), disabled: this.disabled, innerHTML: this.previousYearButtonContent || undefined, onClick: this.previousYear, type: "button" }, h("slot", { key: 'eec62b35b038f0630a52fb71ea07c6a78469fa1a', name: "button-year-prev" }, h("svg", { key: '9febac681c4180bdd787fe5397c133873f8c054d', fill: "none", height: "24", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "24" }, h("polyline", { key: '7c3b869d6b077e0413b4e8347603209cbf9c95b9', points: "11 17 6 12 11 7" }), h("polyline", { key: 'c379eb89405f9eea9cc6a4dd55e9c981f5482031', points: "18 17 13 12 18 7" }))))), this.showMonthStepper && (h("button", { key: '06be659c5dcfc0bbf1a9566a3853eab472ccdab6', "aria-label": this.labels.previousMonthButton, class: {
                [this.getClassName('previous-month-button')]: true,
                [this.getClassName('next-month-button--disabled')]: this.isPreviousMonthDisabled
            }, disabled: this.disabled || this.isPreviousMonthDisabled, innerHTML: this.previousMonthButtonContent || undefined, onClick: this.previousMonth, type: "button" }, h("slot", { key: '3f8b82a20f1831dd0f9ae13f601e6a7b9d7d0f66', name: "button-month-prev" }, h("svg", { key: '4ece2af1856e9c23a55844d72308ca5ba7a07636', fill: "none", height: "24", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "24" }, h("polyline", { key: '880364e4c8cb697e3dac756756630ecfa12fc11c', points: "15 18 9 12 15 6" }))))), h("span", { key: '32647c49b1c8cd81514dcae8f522b6d51bbb8aee', class: this.getClassName('current-month') }, h("select", { key: 'de9f1f2e77961b167455a04842b5ac6a699ff0f7', title: this.labels.monthSelect, "aria-label": this.labels.monthSelect, class: this.getClassName('month-select'), disabled: this.disabled, onChange: this.onMonthSelect }, getMonths(this.locale).map((month, index) => (h("option", { key: month, disabled: this.isMonthOutOfRange(this.currentDate.getFullYear(), index), selected: this.currentDate.getMonth() === index, value: index + 1 }, month)))), h("input", { key: 'e7e5831d0d1b6d8caad4368644395d414c379565', title: this.labels.yearSelect, "aria-label": this.labels.yearSelect, class: this.getClassName('year-select'), disabled: this.disabled, max: (_b = (_a = this.getMaxDate()) === null || _a === void 0 ? void 0 : _a.getFullYear()) !== null && _b !== void 0 ? _b : 9999, maxLength: 4, min: (_d = (_c = this.getMinDate()) === null || _c === void 0 ? void 0 : _c.getFullYear()) !== null && _d !== void 0 ? _d : 1, onChange: this.onYearSelect, type: "number", value: this.currentDate.getFullYear() })), this.showMonthStepper && (h("button", { key: 'e882787c1ee2c42e3a73348c8894b1c4423e6a74', "aria-label": this.labels.nextMonthButton, class: {
                [this.getClassName('next-month-button')]: true,
                [this.getClassName('next-month-button--disabled')]: this.isNextMonthDisabled
            }, disabled: this.disabled || this.isNextMonthDisabled, innerHTML: this.nextMonthButtonContent || undefined, onClick: this.nextMonth, type: "button" }, h("slot", { key: 'aeaab1601d337d37b8cf107b9febbd9a2a117881', name: "button-month-next" }, h("svg", { key: 'fdcde0cc5af9e3f582bf669f7a2492ba9512d759', fill: "none", height: "24", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "24" }, h("polyline", { key: 'a44728996114fe1a03e3710d6e865fc78157ed20', points: "9 18 15 12 9 6" }))))), this.showYearStepper && (h("button", { key: '96402f11750204bf7f747a5f93964528cad5d533', "aria-label": this.labels.nextYearButton, class: this.getClassName('next-year-button'), disabled: this.disabled, innerHTML: this.nextYearButtonContent || undefined, onClick: this.nextYear, type: "button" }, h("slot", { key: 'b47b97fbaf6488b4143bf6133e97648b2cdda779', name: "button-year-next" }, h("svg", { key: '49b093b1cbf5ee8bffe661ba74f759588b6192e6', fill: "none", height: "24", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", stroke: "currentColor", viewBox: "0 0 24 24", width: "24" }, h("polyline", { key: 'a39c967788d8a9f0ed122ffdab30b8f95cc732fb', points: "13 17 18 12 13 7" }), h("polyline", { key: '73c301808950bb91192f689a5ec1439a43139355', points: "6 17 11 12 6 7" })))))), h("div", { key: '19e164c3cf677ef352d65e6264ad1a89e0500faf', class: this.getClassName('body') }, h("table", { key: '04ebf6087e5230a9097398e55cf3ce55651f53cf', class: this.getClassName('calendar'), onKeyDown: this.onKeyDown, role: "grid", "aria-label": this.getGridTitle(), "aria-multiselectable": this.range ? 'true' : 'false' }, h("thead", { key: 'd0f59e46cc8421e21d3253d957e327d4fd496717', class: this.getClassName('calendar-header') }, h("tr", { key: '4cb58d808223eb6c1731fecdfb7e29439ecfb7ab', class: this.getClassName('weekday-row') }, this.weekdays.map((weekday) => (h("th", { "aria-label": weekday[1], abbr: weekday[1], class: this.getClassName('weekday'), key: weekday[0], scope: "col" }, h("span", null, weekday[0])))))), h("tbody", { key: 'e9f7cf25f92a9bd5a801bd82937478c1fa3558ac' }, this.getCalendarRows().map((calendarRow) => {
        ...
        })))), showFooter && (h("div", { key: '20faa4f76b8424b994ef10c6d336687d4d61d5a9', class: this.getClassName('footer') }, this.showTodayButton && (h("button", { key: 'd20c83f63dfb36479bc0f77e4200139480abb910', class: this.getClassName('today-button'), disabled: this.disabled, onClick: this.showToday, type: "button" }, h("slot", { key: '051a8b9e71a772f657b830dac19a78c1f7ca7bbe', name: "button-today" }, this.labels.todayButton))), this.showClearButton && (h("button", { key: 'bbb20e50dc454efe6bd8303bac2bedc085122faf', class: this.getClassName('clear-button'), disabled: this.disabled, onClick: this.clear, type: "button" }, h("slot", { key: '9359ab9370cbdfce73ba844d6a1992d047de3e3b', name: "button-clear" }, this.labels.clearButton))))))));
    }
            ...
            "labels": {
                ...
                "complexType": {
                    ...
                    "references": {
                        "WCDatepickerLabels": {
                            "location": "local",
                            "path": "/Users/paulkinchla/projects/wc-datepicker/src/components/wc-datepicker/wc-datepicker.tsx",
                            "id": "src/components/wc-datepicker/wc-datepicker.tsx::WCDatepickerLabels"
                        }
                    }
                },
                "required": false,
                ...
                "complexType": {
                    ...
                    "references": {
                        "MonthChangedEventDetails": {
                            "location": "local",
                            "path": "/Users/paulkinchla/projects/wc-datepicker/src/components/wc-datepicker/wc-datepicker.tsx",
                            "id": "src/components/wc-datepicker/wc-datepicker.tsx::MonthChangedEventDetails"
                        }
                    }
                }
            }];
    ...
    static get watchers() {
        return [{
                ...
                "propName": "minDate",
                "methodName": "handleMinDate"
            }, {
                "propName": "maxDate",
                "methodName": "handleMaxDate"
            }];
    }
}
